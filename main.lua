...
local GameList = game:HttpGet('https://raw.githubusercontent.com/Kote324/SquaerW/main/gamelist.json')
function GetGame()
...
if Game then
    Supported = true
    Script = game:HttpGet('https://raw.githubusercontent.com/Kote324/SquaerW/main/' .. Game.ScriptName)
end
...
DropShadow.ZIndex = 0
DropShadow.Image = "rbxasset://textures/SpawnLocation.png"
